...
create table if not exists assetsaccount (
  ...
  balance int(20) default 0 comment '账户余额(分)',
  created datetime not null default current_timestamp comment '创建时间',
  creator varchar(38) not null comment '创建人',
  modifier varchar(38) comment '修改人',
  modified datetime not null default current_timestamp comment '修改时间',
  primary key(id),
...
create table if not exists liabilityaccount (
  ...
  name varchar(38) not null comment '账户名称',
  type int(11) not null comment '账户类型',
  lineofcredit int(20) default 0 comment '信用额度(分)',
  statementdate datetime not null default current_timestamp comment '出账日期',
  repaymentdate datetime not null default current_timestamp comment '还款日期',
  created datetime not null default current_timestamp comment '创建时间',
  creator varchar(38) not null comment '创建人',
  modifier varchar(38) comment '修改人',
  modified datetime not null default current_timestamp comment '修改时间',
